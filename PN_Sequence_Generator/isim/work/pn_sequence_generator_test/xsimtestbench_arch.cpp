...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_pn_sequence_generator_test_testbench_arch(const char*);
        topvh = createWork_pn_sequence_generator_test_testbench_arch("PN_Sequence_Generator_test");
